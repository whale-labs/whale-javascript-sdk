 ...
 */
export function pageView(pageName, pageInfo) {
 ...
 */
export function track(eventName, eventInfo) {
 ...
 */
export function registerSuperProperty(superPropertyName, superPropertyValue) {
 ...
 */
export function registerSuperProperties(superProperties) {
 ...
 */
export function unRegisterSuperProperty(superPropertyName) {
 ...
 */
export function getSuperProperty(superPropertyName) {
 ...
 */
export function identify(distinctId) {
 ...
 * @param  {[String/Number/Boolean/Array]} propertyValue [description] 支持类型：String/Number/Boolean/Array;若为字符串,则最大长度255字符;若为数组或集合,则最多包含100条,且key约束条件与属性名称一致,value最大长度255字符
 */
export function profileSetOnce(propertyName, propertyValue) {
 ...
 */
export function profileUnset(property) {
